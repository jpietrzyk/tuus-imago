export interface Translations {
  ...
  admin: {
    ...
    labels: {
      ...
      shippingFreeThresholdHint: string;
      shippingSortOrder: string;
      shippingDefault: string;
      shippingDefaultHint: string;
      shippingSearchName: string;
      shippingNotFound: string;
      shippingBackToShipping: string;
      shippingDetails: string;
      shippingUpdated: string;
      shippingNone: string;
      orderItemShipping: string;
