...
export function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        <div
          className={`w-full max-w-2xl transition-all duration-500 ease-in-out ${
            isLegalDrawerOpen || isAboutDrawerOpen
      ...
      {/* Footer */}
      <Footer
        isLegalDrawerOpen={isLegalDrawerOpen}
        onLegalDrawerOpenChange={setIsLegalDrawerOpen}
        isAboutDrawerOpen={isAboutDrawerOpen}
        onAboutDrawerOpenChange={setIsAboutDrawerOpen}
      />
    </div>
  );
}
